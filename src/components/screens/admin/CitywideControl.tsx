...
export function CitywideControl() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Dialog open={showOutageManage} onOpenChange={setShowOutageManage}>
          ...
          <div className="space-y-4 mt-4">
            <div className="bg-rose-50 border border-rose-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-rose-900">Store Outage: ST-102</h4>
                  <p className="text-sm text-rose-700 mt-1">Power Failure</p>
                  <p className="text-xs text-rose-600 mt-2">
                    This store is currently offline due to a power failure. Orders are being redirected to nearby stores.
                  </p>
                </div>
              </div>
            </div>
            <div className="space-y-3">
              <div>
                ...
                <select className="w-full px-3 py-2 border border-[#e4e4e7] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-rose-500">
            ...
            <div className="flex gap-3 pt-4">
              <Button 
                variant="outline" 
                className="flex-1"
                onClick={() => setShowOutageManage(false)}
              >
                Cancel
              </Button>
              <Button 

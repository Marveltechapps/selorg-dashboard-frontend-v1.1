...
export function SurgeControlModal({ 
  ...
  const loadSurgeInfo = async () => {
    ...
    try {
      ...
      setSurgeInfo(data);
      setGlobalMultiplier(data.globalMultiplier || 1.0);
    } catch (error) {
          ...
          {surgeInfo.active && (
            <div className="bg-orange-50 border border-orange-200 p-4 rounded-lg">
              <div className="grid grid-cols-3 gap-4 mb-4">
                <div>
                  <div className="text-sm text-orange-700">Total Demand</div>
                  <div className="text-2xl font-bold text-orange-900">987</div>
                  <div className="text-xs text-orange-600">orders</div>
                </div>
                <div>
                  <div className="text-sm text-orange-700">Available Capacity</div>
                  <div className="text-2xl font-bold text-orange-900">1,204</div>
                ...
                <div>
                  ...
                  <div className="text-xs text-orange-600">capacity</div>
                </div>
              </div>

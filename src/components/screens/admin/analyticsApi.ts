...
export async function fetchTimeSeriesData(range: string = '24h'): Promise<TimeSeriesData[]> {
  try {
    ...
    return response.data || MOCK_TIME_SERIES_DATA;
  } catch (error) {
...
export async function fetchProductPerformance(): Promise<ProductPerformance[]> {
  try {
    ...
    return response.data || MOCK_PRODUCT_PERFORMANCE;
  } catch (error) {
...
export async function fetchCategoryAnalytics(): Promise<CategoryAnalytics[]> {
  try {
    ...
    return response.data || MOCK_CATEGORY_ANALYTICS;
  } catch (error) {
...
export async function fetchRegionalPerformance(): Promise<RegionalPerformance[]> {
  try {
    ...
    return response.data || MOCK_REGIONAL_PERFORMANCE;
  } catch (error) {
    console.error('Failed to fetch regional performance:', error);
    return MOCK_REGIONAL_PERFORMANCE;
  }
}
...
export async function fetchCustomerMetrics(): Promise<CustomerMetrics> {
  try {
    ...
    return response.data || MOCK_CUSTOMER_METRICS;
  } catch (error) {
    console.error('Failed to fetch customer metrics:', error);
    return MOCK_CUSTOMER_METRICS;
  }
}
...
export async function fetchOperationalMetrics(): Promise<OperationalMetrics> {
  try {
    ...
    return response.data || MOCK_OPERATIONAL_METRICS;
  } catch (error) {
    console.error('Failed to fetch operational metrics:', error);
    return MOCK_OPERATIONAL_METRICS;
  }
}
...
export async function fetchRevenueBreakdown(): Promise<RevenueBreakdown[]> {
  try {
    ...
    return response.data || MOCK_REVENUE_BREAKDOWN;
  } catch (error) {
...
export async function fetchGrowthTrends(): Promise<GrowthTrend[]> {
  try {
    ...
    return response.data || MOCK_GROWTH_TRENDS;
  } catch (error) {
    console.error('Failed to fetch growth trends:', error);
    return MOCK_GROWTH_TRENDS;
  }
}
...
export async function fetchPeakHours(): Promise<PeakHourData[]> {
  try {
    ...
    return response.data || MOCK_PEAK_HOURS;
  } catch (error) {
...
export async function fetchConversionFunnel(): Promise<ConversionFunnel[]> {
  try {
    ...
    return response.data || MOCK_CONVERSION_FUNNEL;
  } catch (error) {
...
export async function fetchPaymentMethods(): Promise<PaymentMethodAnalytics[]> {
  try {
    ...
    return response.data || MOCK_PAYMENT_METHODS;
  } catch (error) {

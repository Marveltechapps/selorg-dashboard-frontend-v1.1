...
import * as grnApi from '../../../api/inventory-management/grn.api';
...
const mockGRNs: GRN[] = [
  {
    ...
    lineItems: [
      { sku: 'SKU-001', product: 'Tomatoes', ordered: 100, received: 100, unit: 'kg', status: 'Complete' },
      { sku: 'SKU-002', product: 'Onions', ordered: 50, received: 50, unit: 'kg', status: 'Complete' },
    ],
    qualityChecked: true,
  ...
  },
  {
    ...
    exceptionType: 'No Issue',
    lineItems: [
      { sku: 'SKU-101', product: 'Delivery Boxes', ordered: 500, received: 500, unit: 'units', status: 'Complete' },
    ],
  },
  {
    id: '3',
    ...
    exceptionDetails: 'Damaged 5 units',
    lineItems: [
      { sku: 'SKU-201', product: 'Milk Bottles', ordered: 200, received: 195, unit: 'units', status: 'Damaged' },
    ],
  },
  {
    id: '4',
    ...
    status: 'Approved',
    exceptionType: 'Short',
    exceptionDetails: 'Short 5 kg',
    lineItems: [
      { sku: 'SKU-001', product: 'Tomatoes', ordered: 100, received: 95, unit: 'kg', status: 'Short' },
    ],
  },
  {
    id: '5',
    ...
    exceptionDetails: 'Excess 10',
    lineItems: [
      { sku: 'SKU-301', product: 'Spice Packets', ordered: 100, received: 110, unit: 'boxes', status: 'Excess' },
    ],
  },
  {
    id: '6',
    ...
    exceptionType: 'No Issue',
    lineItems: [
      { sku: 'SKU-401', product: 'Turmeric Powder', ordered: 200, received: 200, unit: 'kg', status: 'Complete' },
    ],
  },
  {
    id: '7',
    ...
    shipmentId: 'SHP-9910',
    vendor: 'Fresh Farms Inc.',
    warehouse: 'Dark Store 2',
    date: 'Dec 16, 2024',
    status: 'Approved',
    exceptionType: 'No Issue',
    lineItems: [
      { sku: 'SKU-002', product: 'Potatoes', ordered: 150, received: 150, unit: 'kg', status: 'Complete' },
    ],
  },
  {
    id: '8',
    ...
    status: 'Approved',
    exceptionType: 'Damaged',
    exceptionDetails: 'Damaged 3',
    lineItems: [
      { sku: 'SKU-201', product: 'Milk Bottles', ordered: 200, received: 197, unit: 'units', status: 'Damaged' },
    ],
  },
];
...
const mockShipments: Shipment[] = [
  {
    ...
    shipmentId: 'SHP-9930',
    vendor: 'Fresh Farms Inc.',
    currentLocation: 'Highway A1, 25km from Warehouse',
    eta: '2:30 PM',
    status: 'In Transit',
    driver: 'John Smith',
...
const mockRTVs: RTV[] = [
  {
    id: '1',
    rtvNumber: 'RTV-2024-001',
    grnReference: 'GRN-2024-004',
    reason: 'Short Goods',
    quantity: '5 kg',
    status: 'Open',
    vendor: 'Fresh Farms Inc.',
    createdDate: 'Dec 18, 2024',
    items: ['Tomatoes - 5 kg short'],
  },
  {
    id: '2',
    rtvNumber: 'RTV-2024-002',
    grnReference: 'GRN-2024-008',
    reason: 'Damaged Goods',
    quantity: '3 units',
    status: 'In Transit',
    vendor: 'Dairy Delights',
    createdDate: 'Dec 16, 2024',
    items: ['Milk Bottles - 3 damaged'],
  },
];
...
export function InboundOperations() {
  ...
  const saveSnapshot = (nextGrns: GRN[], nextRtvs: RTV[]) => {
    try {
      ...
      console.warn('Failed to persist inbound state', e);
    }
  };
  ...
  React.useEffect(() => {
    ...
    try {
      ...
      // BroadcastChannel may not be available in some environments - fallback to storage event
      const onStorage = (ev: StorageEvent) => {
        if (ev.key === 'inboundState' && ev.newValue) {
          try {

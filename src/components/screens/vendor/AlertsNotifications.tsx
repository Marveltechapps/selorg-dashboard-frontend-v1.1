...
const mockAlerts: Alert[] = [
  {
    ...
    severity: 'Critical',
    type: 'QC Failure',
    title: 'QC Failure: Dairy Delights',
    description: 'Batch #9922 failed temperature check. Entire shipment rejected.',
    timestamp: 'Dec 19, 10:05 AM',
    timeAgo: '10 mins ago',
    status: 'Open',
    isRead: false,
  ...
  },
  {
    ...
    description: 'Shipment SHP-9924 from Tech Logistics is delayed by 2 hours.',
    timestamp: 'Dec 19, 9:35 AM',
    timeAgo: '30 mins ago',
    status: 'Acknowledged',
    isRead: true,
  ...
  },
  {
    ...
    description: 'PO-2024-0012 to Fresh Farms has not been acknowledged for 24 hours.',
    timestamp: 'Dec 19, 9:05 AM',
    timeAgo: '1 hour ago',
    status: 'Open',
    isRead: false,
    vendor: 'Fresh Farms',
  ...
  },
  {
    ...
    description: 'New vendor "Organic Harvests" has been successfully registered.',
    timestamp: 'Dec 19, 8:30 AM',
    timeAgo: '2 hours ago',
    status: 'Open',
    isRead: true,
    vendor: 'Organic Harvests',
  },
  {
    id: '5',
    severity: 'Resolved',
    ...
    description: 'Batch #9921 passed all quality checks and cleared for distribution.',
  ...
  },
  {
    ...
    title: 'Certification Expired: Global Spices',
    description: 'GMP Certificate expired. Vendor cannot fulfill orders until renewal.',
    timestamp: 'Dec 19, 7:45 AM',
    timeAgo: '3 hours ago',
    status: 'Open',
    isRead: false,
  ...
  },
  {
    ...
    description: 'Invoice INV-2024-0047 is 15 days overdue. Total: ₹2,25,000',
    timestamp: 'Dec 19, 7:15 AM',
    timeAgo: '3 hours ago',
    status: 'Acknowledged',
    isRead: true,
    vendor: 'Fresh Farms',
  },
  {
    ...
    description: 'Organic Tomatoes stock below reorder point. Current: 25 kg',
    timestamp: 'Dec 19, 6:30 AM',
    timeAgo: '4 hours ago',
    status: 'Open',
    isRead: true,
  },

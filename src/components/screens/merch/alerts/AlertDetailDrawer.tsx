                ...
                {/* Audit Log / Timeline */}
                 <div className="space-y-4">
                    ...
                    <div className="space-y-4 relative pl-4 border-l-2 border-gray-100 ml-2">
                        {MOCK_AUDIT_LOGS.filter(l => l.alertId === alert.id || alert.id !== '4').map((log, i) => (
                             // Showing general logs for demo if specific ID matches or falling back to generic ones for other mock items
                        ...
                        {/* Always show "Created" for current alert */}

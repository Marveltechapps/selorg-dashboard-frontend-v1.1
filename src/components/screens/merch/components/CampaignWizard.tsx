          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
            <div className="flex items-center space-x-2">
              <div className="relative flex-1">
                ...
                <Input className="pl-10 h-11 border-2" placeholder="Search SKUs by name, ID or category..." />
              </div>
            ...
            <div className="space-y-4">
                <div className="flex justify-between items-center">
                    ...
                    <Button variant="ghost" size="sm" className="text-[#7C3AED] font-bold" onClick={() => setFormData({...formData, skus: ['1', '2', '3', '4', '5']})}>
                        Add All Recommendation
                    </Button>
                </div>
                ...
                <div className="border-2 rounded-xl overflow-hidden bg-gray-50/30">
                    ...
                    {formData.skus.length === 0 ? (
                                <div className="flex flex-col items-center justify-center py-20 text-gray-400">
                                    ...
                                    <p className="text-xs">Search or use recommendations to add products</p>
                                </div>
                            ) : (
                                ...
                                <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="font-bold text-gray-900">Premium Product SKU {id}</p>
                                                <div className="flex gap-2 mt-1">
                                                    <Badge variant="secondary" className="text-[10px] px-1.5 py-0">Beverages</Badge>
                                                    <p className="text-[10px] text-gray-500 font-medium">ID: BEV-{2000 + parseInt(id)}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-6">
                                            <div className="text-right">
                                                ...
                                                <p className="text-[10px] text-green-600 font-bold">Stock: 1,200</p>
                                    </div>
                                    <Button 
                                        variant="ghost" 
                                        size="icon" 

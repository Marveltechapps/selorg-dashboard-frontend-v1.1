  ...
  return (
    <div className="space-y-6">
      ...
      <ActiveCampaignsModal 
        ...
        onViewDetail={(campaign) => handleCampaignAction('detail', campaign as any)}
      />
      <PromoUpliftModal 

...
const MOCK_HISTORY_DATA = [
  { week: 'W1', demand: 400, stock: 450 },
  { week: 'W2', demand: 380, stock: 420 },
  { week: 'W3', demand: 520, stock: 400 },
  { week: 'W4', demand: 450, stock: 350 },
                    ...
                    <TabsContent value="overview" className="p-4 m-0 space-y-4">
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <div className="p-3 border rounded-lg bg-gray-50">
                                ...
                                <p className="text-[9px] text-gray-500 mt-0.5">Arriving via 3 POs</p>
                            </div>
                            <div className="p-3 border rounded-lg bg-gray-50">

...
const MOCK_ALERTS: Alert[] = [
    ...
    },
    {
        ...
        message: 'Projected stockout in 12 hours.',
        time: '12h'
    }
];
...
export function ReplenishmentAlertsPanel() {
  ...
  const handleAction = (alert: Alert) => {
      console.log('Action triggered for alert:', alert);
        ...
        <ScrollArea className="flex-1 pr-4">
            <div className="space-y-3">
                {filteredAlerts.length === 0 ? (
                    ...
                    <div key={alert.id} className={`flex items-start gap-3 p-3 rounded-lg border relative group transition-all ${

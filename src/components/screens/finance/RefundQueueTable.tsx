                ...
                {data.map((refund) => (
                    <tr key={refund.id} className="hover:bg-[#FAFAFA] group transition-colors cursor-pointer" onClick={() => onViewDetails(refund)}>
                        ...
                        <td className="px-6 py-4 text-[#616161]">
                            <span className="block capitalize text-[#212121] mb-0.5">{refund.reasonCode.replace('_', ' ')}</span>
                            <span className="text-xs truncate max-w-[200px] block">{refund.reasonText}</span>
                        </td>

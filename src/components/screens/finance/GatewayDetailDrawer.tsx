                 ...
                 <div className="grid grid-cols-2 gap-4">
                     <div className="p-4 rounded-lg bg-gray-50 border border-gray-100">
                         ...
                         <p className="text-xl font-bold text-gray-900 mt-1">
                             {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD', maximumFractionDigits: 0 }).format(gateway.matchedAmount + gateway.pendingAmount + gateway.mismatchAmount)}
                         </p>
                     </div>
                      <div className="p-4 rounded-lg bg-gray-50 border border-gray-100">
                     ...
                     <div className="space-y-3">
                         <div className="flex items-center justify-between p-3 rounded hover:bg-gray-50 transition-colors">
                             ...
                             <span className="font-mono font-medium">
                                 {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(gateway.matchedAmount)}
                             </span>
                         </div>
                         ...
                         <div className="flex items-center justify-between p-3 rounded hover:bg-gray-50 transition-colors">
                             ...
                             <span className="font-mono font-medium">
                                 {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(gateway.pendingAmount)}
                             </span>
                         </div>
                         ...
                         <div className="flex items-center justify-between p-3 rounded bg-red-50 border border-red-100">
                             ...
                             <span className="font-mono font-bold text-red-700">
                                 {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(gateway.mismatchAmount)}
                             </span>
                         </div>
                     </div>
                 </div>

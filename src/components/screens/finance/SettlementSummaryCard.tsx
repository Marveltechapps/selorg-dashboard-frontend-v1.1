                        ...
                        <div className="space-y-3">
                             <div className="flex justify-between text-sm">
                                 ...
                                 <span className="font-medium text-[#212121]">
                                     {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD', maximumFractionDigits: 0 }).format(item.matchedAmount)}
                                 </span>
                             </div>
                             ...
                             {item.mismatchAmount > 0 && (
                                 <div className="flex justify-between text-sm">
                                     ...
                                     <span className="font-bold text-red-600">
                                         {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(item.mismatchAmount)}
                                     </span>
                                 </div>
                             )}
                             ...
                             {item.pendingAmount > 0 && (
                                 <div className="flex justify-between text-sm">
                                     ...
                                     <span className="font-medium text-yellow-600">
                                         {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(item.pendingAmount)}
                                     </span>
                                 </div>
                             )}

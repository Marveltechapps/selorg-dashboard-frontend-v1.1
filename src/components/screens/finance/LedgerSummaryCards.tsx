  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
       ...
       >
         ...
         <div className="flex items-end gap-2">
             <span className="text-3xl font-bold text-[#212121]">
                {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD', notation: "compact" }).format(summary.generalLedgerBalance)}
             </span>
       ...
       >
         ...
         <div className="flex items-end gap-2">
             <span className="text-3xl font-bold text-[#212121]">
                {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD', notation: "compact" }).format(summary.receivablesBalance)}
             </span>
       ...
       >
         ...
         <div className="flex items-end gap-2">
             <span className="text-3xl font-bold text-[#212121]">
                {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD', notation: "compact" }).format(summary.payablesBalance)}
             </span>

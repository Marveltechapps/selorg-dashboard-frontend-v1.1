          ...
          >
             ...
             <div className="flex items-end gap-2">
                 <span className="text-3xl font-bold text-[#212121]">
                    {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD', maximumFractionDigits: 0 }).format(summary.outstandingPayablesAmount)}
                 </span>
          ...
          >
             ...
             <div className="flex items-end gap-2">
                 <span className="text-3xl font-bold text-[#EF4444]">
                     {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD', maximumFractionDigits: 0 }).format(summary.overdueAmount)}
                 </span>
